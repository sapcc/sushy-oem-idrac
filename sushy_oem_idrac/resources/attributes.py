...
class DellAttributes(base.ResourceBase):
    ...
    for the DellAttributes Attributes resource
    """

    attributes = base.Field('Attributes')
    """Vendor-specific key-value dict of effective DellAttributes attributes
    ...
    def get_attribute_registry(self, language='en'):
        """Get the Attribute Registry associated with this DellAttributes instance
